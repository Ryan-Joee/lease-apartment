package com.ryan.lease.web.admin.controller.system;
...
import com.ryan.lease.web.admin.service.SystemPostService;
...
public class SystemPostController {
    ...
    public Result updateStatusByPostId(@RequestParam Long id, @RequestParam BaseStatus status) {
        LambdaUpdateWrapper<SystemPost> updateWrapper = Wrappers.lambdaUpdate(SystemPost.class)
